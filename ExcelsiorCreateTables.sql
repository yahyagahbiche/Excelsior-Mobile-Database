CREATE TABLE ExcelsiorMobile.dbo.Device (
...
CREATE TABLE ExcelsiorMobile.dbo.MPlan (
...
CREATE TABLE ExcelsiorMobile.dbo.DirNums (
...
CREATE TABLE ExcelsiorMobile.dbo.Subscriber (
...
CREATE TABLE ExcelsiorMobile.dbo.Bill (
...
CREATE TABLE ExcelsiorMobile.dbo.LastMonthUsage (
	MIN bigint NOT NULL PRIMARY KEY FOREIGN KEY REFERENCES Subscriber(MIN),
